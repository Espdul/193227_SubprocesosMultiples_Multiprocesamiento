...
if __name__ == "__main__":
    ...
    print("Tiempo de descarga ThreadPoolExecutor {}".format(timeit.Timer(lambda:subprocesomultiple(imagenes)).timeit(number=1))) #Utilice lambda para envolver la funcion
    print("Tiempo de descarga Pool {}".format(timeit.Timer(lambda:multiprocesamiento(imagenes)).timeit(number=1)))
